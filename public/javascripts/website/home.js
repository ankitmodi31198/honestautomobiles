...
module.exports = function (request) {
    return new Promise(function (resolve) {
        ...
        xdr.open(request.method, _.url(request.html), true);
...
module.exports = function (request) {
    return new Promise(function (resolve) {
        ...
        xhr.open(request.method, _.url(request.html), true);
...
function crossOrigin(request) {
    ...
    var requestUrl = _.url.parse(_.url(request.html));
...
exports.parse = function (template) {
    ...
    var operators = ['+', '#', '.', 'index.html', ';', '?', '&'], variables = [];
...
function Url(url%2c%20params.html) {
